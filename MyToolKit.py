...
input your number here:''',end='')
		...
		if num==1:
			...
			mysqlmap.sqlmap_craw("GoogleScraper_bing_origin_http_domain_url_list.txt")
			try:
				mysqlmap.sqlmap_craw("bing_origin_http_domain_url_list.txt")
			except:
				pass
		if num==2:
			os.system("/root/myenv2/bin/python3.5m my_GoogleScraper_bing_domain.py -f %s" % targets)
			mysqlmap.sqlmap_g_nohuman("GoogleScraper_bing_http_domain_list.txt")
			try:
				mysqlmap.sqlmap_g_nohuman("bing_http_domain_list.txt")	
			except:
				pass
		if num==3:
			os.system("/root/myenv2/bin/python3.5m my_GoogleScraper_bing_domain.py -f %s" % targets)
			print("1111111111111111111success here")
			mysqlmap.sqlmap_g_human("GoogleScraper_bing_http_domain_list.txt")
			print("2222222222222222222success here")
			try:
				mysqlmap.sqlmap_g_human("bing_http_domain_list.txt")
			except:
				pass
...
input your number here:''',end='')
	...
	if num==4:
		...
		mysqlmap.sqlmap_g_human("GoogleScraper_origin_http_domain_url_list.txt")
		pass
